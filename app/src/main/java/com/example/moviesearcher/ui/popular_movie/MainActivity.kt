...
import com.example.moviesearcher.data.api.TheMovieDBClient
...
import com.example.moviesearcher.ui.single_movie_details.SingleMovie
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.networkState.observe(this, Observer {
            ...
            text_error_popular.visibility = if(viewModel.listEmpty() && it == NetworkState.ERROR) View.VISIBLE else View.GONE
